...
#2	2783			
#3	962	
#link:http://girke.bioinformatics.ucr.edu/GEN242/pages/mydoc/Rclustering.html
#link:https://uc-r.github.io/hc_clustering optimal k of hc
```
...
#模型对非流失客户(no)的预测还是非常准确的（1408/(1408+35)=97.6%）;
#模型对流失客户(yes)的预测非常不理想（42/(182+42)=18.8%）
#模型的整体预测准确率为87.0%((1408+42)/(1408+35+182+42))，还算说得过去。
#link:https://zhuanlan.zhihu.com/p/28414024
